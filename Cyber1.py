...
def Main():
        ...
        os.system("xdg-open https://facebook.com/groups/1345566289582031/");xyz()
...
def hasan(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[NASIM]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
